...
ECHO    #+++++++++++++++++++++++++++++++++#+++++++++++++++++++++++++++++++++++#
ECHO    # 01．禁用索引服務                # 26．將臨時資料夾移動到非系統碟    #
ECHO    # 02．禁止Windows發送錯誤報告     # 27．關閉 HomeGroup 家用群組       #
ECHO    # 03．禁用"最近使用的項目"        # 28．延遲啟動 Superfetch 服務      #
ECHO    # 04．關閉Windows Defender        # 29．設定免輸密碼自動登入          #
ECHO    # 05．關閉防火牆                  # 30．關閉開機畫面（GUI引導）       #
ECHO    # 06．檢查更新而不自動下載更新    # 31．關閉 IPv6                     #
ECHO    # 07．啟動電源計劃「高效能」      # 32．關閉不需要的視覺特效          #
ECHO    # 08．調整電源選項                # 33．關閉客戶體驗改善計劃          #
ECHO    # 09．禁用休眠（刪除休眠檔案）    # 34．隱藏重要訊息中心工作列圖示    #
ECHO    # 10．開啟快速啟動                # 35．關閉自動播放或自動打開隨身碟  #
ECHO    # 11．調整休眠檔案大小            # 36．設定視窗超窄邊框              #
ECHO    # 12．轉移虛擬記憶體              # 37．資源回收筒右鍵固定到開始選單  #
ECHO    # 13．關閉系統保護                # 38．不經由資源回收筒，直接刪除檔案#
ECHO    # 14．關閉使用者帳戶控制(UAC)     # 39．關閉 SmartScreen 篩選工具     #
ECHO    # 15．Windows To Go啟用應用商店   # 40．關機時強制關閉背景程式不等待  #
...
ECHO    # 21．禁止一上網就打開瀏覽器      # 46．工作列顯示「星期幾」          #
ECHO    # 22．刪除6個資料夾(暫失效)       # 47．設定系統內建截圖儲存到桌面    #
...
ECHO  *************************************************************************
ECHO.
ECHO      備註：第2、3、4、5、12、13、14、15項機碼在同一個地方，需要一起設定
ECHO.
ECHO.
